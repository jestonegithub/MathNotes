define(function (require) {
    ...
    var tmp = require('hbs!app/templates/dirichletNotes/dirichletNotesTheTheorem');


    //This is a View - and the root view of the game living in #main

    var DirichletNotesTheTheoremView = mn.ItemView.extend({

        template: tmp,

        id:'dirichletNotesTheTheorem',
    ...
    return {DirichletNotesTheTheoremView:DirichletNotesTheTheoremView}
