define(function (require) {
    ...
    var tmp = require('hbs!app/templates/dirichletNotes/dirichletNotesAboutIssue');


    //This is a View - and the root view of the game living in #main

    var DirichletNotesAboutIssueView = mn.ItemView.extend({

        template: tmp,

        id:'dirichletNotesCover',
    ...
    return {DirichletNotesAboutIssueView:DirichletNotesAboutIssueView}
